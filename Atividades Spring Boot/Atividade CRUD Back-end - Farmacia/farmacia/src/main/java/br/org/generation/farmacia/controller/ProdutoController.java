...
public class ProdutoController {
	...
	@GetMapping("/preco_inicial/{min_preco}/preco_final/{max_preco}")
	public ResponseEntity <List<Produto>> getByPrecoBetween(@PathVariable BigDecimal min_preco, @PathVariable BigDecimal max_preco){
		return ResponseEntity.ok(produtoRepository.findByPrecoBetween(min_preco, max_preco));
	}
